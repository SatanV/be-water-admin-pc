...
public class MREncryptUtil {
  ...
  public static String EncryptEx(String mstext) {
    ...
    //用于数据连接
    //string Matrix = @"8x3p5BeabcdfghijklmnoqrstuvwyzACDEFGHIJKLMNOPQRSTUVWXYZ1246790-.#/\!@$<>&*()[]{};:,?=+~`^|%_";
  ...
  /*public static void main(String[] args) {
    System.out.println(MREncryptUtil.EncryptEx("123456"));
  }*/
}